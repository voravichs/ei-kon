 ...
 * Modal
 */
export default function ActionModal({charData, actions, showDiceModal, setShowDiceModal}) {
    const [showModal1Act, setShowModal1Act] = useState(false);
    const [showModal2Act, setShowModal2Act] = useState(false);
    ...
    return(
        <>
            <motion.div>
                {actions === 1 
                ? <TbHexagon1Filled onClick={() => setShowModal1Act(true)}/> 
                : <TbHexagon2Filled onClick={() => setShowModal2Act(true)}/>}
            </motion.div>
            {/* Modal */}
            {showModal1Act ? (
                <>
                    <div className="flex-center overflow-x-hidden overflow-y-auto z-50 fixed inset-0 top-56 outline-none focus:outline-none cursor-default">
                                ...
                                <div className="p-4 border-b border-solid rounded-t text-black">
                                    <div className="grid grid-cols-4 items-center mb-2"> 
                                        ...
                                        <div className="text-3xl flex-center gap-2 col-span-2 text-primary font-bold"> 
                                            <TbHexagon1Filled className="text-5xl"/> Actions 
                                        </div>
                                        {/* Close button */}
                                        <button
                                            className="text-red-500 text-4xl justify-self-end"
                                            type="button"
                                            onClick={() => setShowModal1Act(false)}
                                        >
                                            <IoIosCloseCircle/>
                                        </button>
                                    </div>
                        ...
                        <div className="opacity-50 fixed inset-0 z-40 bg-black" onClick={() => setShowModal1Act(false)}></div>
                    </div>
                </>
            ) : null}
            {/* Modal */}
            {showModal2Act ? (
                <>
                                ...
                                <div className="p-4 border-b border-solid rounded-t text-black">
                                    <div className="grid grid-cols-4 items-center mb-2"> 
                                        ...
                                        <button
                                            className="text-red-500 text-4xl justify-self-end"
                                            type="button"
                                            onClick={() => setShowModal2Act(false)}
                                        >
                                            <IoIosCloseCircle/>
                                        </button>
                                    </div>
                    ...
                    <div className="opacity-50 fixed inset-0 z-40 bg-black" onClick={() => setShowModal2Act(false)}></div>
                    </div>
                </>
            ) : null}
        </>
