...
export default function ClassCard({selectedClass}) {
    // Contexts
    const { keywords, colorSwap} = useOutletContext();
    ...
    return (
        ...
        >
                {/* Title */}
                <div className="h-1/5">
                    <p className={`text-6xl ${colorSwap.text(selectedClass)} font-bold uppercase`}>{selectedClass.class}</p>
                ...
                <motion.div
                    ...
                    <Link to={'/charcreate/jobs'}>
                        <FaArrowCircleRight
                            className={`text-6xl ${colorSwap.text(selectedClass)} cursor-pointer`} />
                    </Link>
