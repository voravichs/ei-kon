        ...
        >
            ...
            <div className="w-1/2">
                ...
                <div className="flex-center gap-4 h-1/6">
                    <div className={`flex-center ${colorSwap.text(characterContext)} text-7xl 2xl:text-8xl`}>{selectedJob.icon}</div>
                    <div className="flex-center flex-col">
                        <p className={`text-5xl 2xl:text-6xl ${colorSwap.text(characterContext)} font-bold uppercase`}>{selectedJob.jobName}</p>
                        <p className="text-xl 2xl:text-2xl italic font-light">{selectedJob.title}</p>
                    </div>
                </div>
                {/* Image */}
            ...
            <div className="w-1/2 flex flex-col justify-between gap-6">
                {/* Description */}
                <div className="font-light flex-center flex-col gap-4 text-sm 2xl:text-lg">
                                ...
                                return (
                                    <div key={trait.name}>
                                        {trait.chapter == 1 &&
                                            ...
                                            >
                                                <p className="font-bold text-lg 2xl:text-2xl flex-center gap-4">{trait.name}</p>
                                                <motion.span
                                                    variants={tooltip}
